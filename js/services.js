	...
	{ // catch the form's submit event
		...
		if(e.handled !== true) // This will prevent event triggering more then once
		{
			...
			if($("#bookwithoutslot").val() == 'Y')
			{
				...
				id_court_timing = '<strong>Court: </strong>' + selected_court + '<br/><strong>Date of Service: </strong>' + selected_date + '<br/><strong>Timing: </strong>' + selected_timing + '<br/>';	
...
{  
	...
	function sendID(id)
	{
		url = "http://happ.phpzeal.com/corephp/send2.php";
